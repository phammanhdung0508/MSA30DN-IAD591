...
# allow_origins=["*"] is not compatible with allow_credentials=True in many browsers.
cors_origins = [
    o.strip() for o in os.getenv("CORS_ALLOWED_ORIGINS", "*").split(",") if o.strip()
]
if "*" in cors_origins and os.getenv("CORS_ALLOWED_ORIGINS"):
    logger.warning("CORS_ALLOWED_ORIGINS contains '*' which may conflict with allow_credentials=True")
