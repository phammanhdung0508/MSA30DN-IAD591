...
# allow_credentials must be False if wildcard is used in allow_origins
# to prevent insecure credentialed requests from any origin.
# We also allow overriding via CORS_ALLOW_CREDENTIALS env var (default true).
allow_creds = (
